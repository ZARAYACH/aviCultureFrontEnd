        ...
        <div className="h-screen">
            <div className="max-w-[50rem] flex flex-col mx-auto w-full h-5/6">
                ...
                <div className="text-center py-10 px-4 sm:px-6 lg:px-8">
                    <h1 className="block text-7xl font-bold text-gray-800 sm:text-9xl dark:text-white">See you Next
                        time</h1>
                    <h1 className="block text-2xl font-bold text-white"></h1>
                    <p className="mt-3 text-gray-600 dark:text-gray-400">Thank you. <br/> You will be redirected to the
                        Login page in {seconds} seconds</p>
                </div>
            </div>
            <div className="h-1/6">
