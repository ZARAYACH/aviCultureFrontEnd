                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            <input
                                                ...
                                                className="py-2 px-3 block w-full border-gray-200 rounded text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400"
