...
import AddStrawBaleModal from "./AddStrawBalesModal";

const ProductStrawBales = () => {

    const [productStrawBales, setproductStrawBales] = useState<ProductStrawBale[]>([]);
    const {axiosInstance} = useAxios();
    const [isAddStrawBaleModalOpen, setIsAddStrawBaleModalOpen] = useState(false);
    const toggleAddStrawBaleModal = () => {
        setIsAddStrawBaleModalOpen(!isAddStrawBaleModalOpen);
    };

    useEffect(() => {
        axiosInstance
            .get(process.env.REACT_APP_API_PREFIX + "/products/straw-bales")
            .then((response) => {
                setproductStrawBales(response.data);
            })
            .catch((error) => {
    ...
    const deleteProductBulb = (id: string) => {
        axiosInstance
            .delete(
                process.env.REACT_APP_API_PREFIX + "/products/straw-bales/" + id + "/delete"
            )
            .then((response) => {
                setproductStrawBales(productStrawBales.filter((productStrawBales, index) => productStrawBales.id !== id));
            })
            .catch((error) => {
                console.error("Error fetching data :", error);
            });
    ...
    return (
        <Fragment>
            {(isAddStrawBaleModalOpen &&
                <AddStrawBaleModal toggleModal={toggleAddStrawBaleModal} setStrawBale={setproductStrawBales}/>)}
                    ...
                    <div className="-m-1.5 overflow-x-auto">
                                ...
                                <div
                                    ...
                                    <div>
                                        <div className="inline-flex gap-x-2">
                                            ...
                                            <button onClick={toggleAddStrawBaleModal}
                        ...
                        <span
                          ...
                          ...
                                    ...
                                    {productStrawBales.map((productBulb) => (
                                        <tr key={productBulb.id}>
                                            <td className="h-px w-px whitespace-nowrap">
                                                <div className="pl-6 py-3">
                                                    <label htmlFor={productBulb.id} className="flex">
                                                        <input
                                                            id={productBulb.id}
                                                            type="checkbox"
                                                            className="shrink-0 border-gray-200 rounded text-blue-600 pointer-events-none focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800"
                                            ...
                                            <td className="h-px w-px whitespace-nowrap">
                                                <div className="px-6 py-3">
                                                    <div className="flex items-center gap-x-2">
                                                        <div className="grow">
                              <span className="text-sm text-gray-600 dark:text-gray-400">
                                {productBulb.storageBuilding?.name}
                              </span>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div
                                                        ...
                                                        >
                                                            ...
                                                            <div className="py-2 first:pt-0 last:pb-0">
                                                                <a
                                                                    onClick={() =>
                                                                        productBulb.id && deleteProductBulb(productBulb.id)
                                                                    }
...
export default ProductStrawBales;
