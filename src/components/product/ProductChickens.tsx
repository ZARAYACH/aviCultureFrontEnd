...
import AddChickenModal from "./AddChickenModal";

const ProductChickens = () => {

    const [productChickens, setProductChickens] = useState<ProductChicken[]>([]);
    const {axiosInstance} = useAxios();
    const [isAddChickenModalOpen, setIsAddChickenModalOpen] = useState(false);
    const toggleAddChickenModal = () => {
        setIsAddChickenModalOpen(!isAddChickenModalOpen);
    };

    useEffect(() => {
        axiosInstance
            .get(process.env.REACT_APP_API_PREFIX + "/products/chickens")
            .then((response) => {
                setProductChickens(response.data);
            })
            .catch((error) => {
    ...
    const deleteProductBulb = (id: string) => {
        axiosInstance
            .delete(
                process.env.REACT_APP_API_PREFIX + "/products/chickens/" + id + "/delete"
            )
            .then((response) => {
                setProductChickens(productChickens.filter((productChickens, index) => productChickens.id !== id));
            })
            .catch((error) => {
    ...
    return (
        <Fragment>
            {(isAddChickenModalOpen &&
                <AddChickenModal toggleModal={toggleAddChickenModal} setChickens={setProductChickens}/>)}
                    ...
                    <div className="-m-1.5 overflow-x-auto">
                                ...
                                <div
                                    ...
                                    <div>
                                        <div className="inline-flex gap-x-2">
                                            ...
                                            <button onClick={toggleAddChickenModal}
                        ...
                        <span
                          ...
                          ...
                                    ...
                                    {productChickens.map((productBulb) => (
...
export default ProductChickens;