...
const ProductFoods = () => {
    ...
    useEffect(() => {
        axiosInstance
            .get(process.env.REACT_APP_API_PREFIX + "/products/foods")
            .then((response) => {
                setProductFoods(response.data);
            })
            .catch((error) => {
    ...
    const deleteProductBulb = (id: string) => {
        axiosInstance
            .delete(
                process.env.REACT_APP_API_PREFIX + "/products/foods/" + id + "/delete"
            )
            .then((response) => {
                setProductFoods(productFoods.filter((productFoods, index) => productFoods.id !== id));
            })
            .catch((error) => {
    ...
    return (
        <Fragment>
            {(isAddFoodModalOpen &&
                <AddFoodModal toggleModal={toggleAddFoodModal} setFoods={setProductFoods}/>)}
