                                            ...
                                            <ul className="todo-list" data-widget="todo-list">
                                                ...
                                                <span className="handle">
                                                    ...
                                                    <div className="icheck-primary d-inline ml-2">
                                                        <input type="checkbox" checked name="todo1" id="todoCheck1"/>
                                                ...
                                                <span className="handle">
                                                    ...
                                                    <div className="icheck-primary d-inline ml-2">
                                                        <input type="checkbox" checked name="todo2" id="todoCheck2"
                                                               defaultChecked/>
                                                ...
                                                <span className="handle">
                                                    ...
                                                    <div className="icheck-primary d-inline ml-2">
                                                        <input type="checkbox" checked name="todo3" id="todoCheck3"/>
                                                        <label htmlFor="todoCheck3"/>
                                                    </div>
                                                    <span className="text">Let theme shine like a star</span>
                                                    <small className="badge badge-warning"><i
                                                        className="far fa-clock"/> 1
                                                        day</small>
                                                    <div className="tools">
                                                        <i className="fas fa-edit"/>
                                                        <i className="fas fa-trash-o"/>
                                                ...
                                                <span className="handle">
                                                    ...
                                                    <div className="icheck-primary d-inline ml-2">
                                                        <input type="checkbox" checked name="todo4" id="todoCheck4"/>
                                                        <label htmlFor="todoCheck4"/>
                                                    </div>
                                                    <span className="text">Let theme shine like a star</span>
                                                    <small className="badge badge-success"><i
                                                        className="far fa-clock"/> 3
                                                        days</small>
                                                    <div className="tools">
                                                        <i className="fas fa-edit"/>
                                                        <i className="fas fa-trash-o"/>
                                                ...
                                                <span className="handle">
                                                    ...
                                                    <div className="icheck-primary d-inline ml-2">
                                                        <input type="checkbox" checked name="todo5" id="todoCheck5"/>
                                                ...
                                                <span className="handle">
                                                    ...
                                                    <div className="icheck-primary d-inline ml-2">
                                                        <input type="checkbox" checked name="todo6" id="todoCheck6"/>
