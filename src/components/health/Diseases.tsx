...
import AddDiseaseModal from "./AddDiseasesModal";
...
const Diseases = () => {
    ...
    const toggleAddDiseaseModal = () => {
        setIsAddDiseaseModalOpen(!isAddDiseaseModalOpen);
    };
    useEffect(() => {
        axiosInstance
    ...
    useEffect(() => {
        axiosInstance.get(process.env.REACT_APP_API_PREFIX + "/products/medicines")
            .then(value => setMedicines(value.data))
            .catch(reason => console.error(reason))
    },[diseases])
    const deleteDisease = (diseaseId: number) => {
        axiosInstance
            .delete(process.env.REACT_APP_API_PREFIX + "/diseases/" + diseaseId + "/delete")
            .then((response) => {
    ...
    return (
        <Fragment>
            {(isAddDiseaseModalOpen &&
                <AddDiseaseModal toggleModal={toggleAddDiseaseModal} setDiseases={setDiseases}/>)}
                                    ...
                                    <div
                                        ...
                                        <div>
                                            <div className="inline-flex gap-x-2">
                                                ...
                                                <button onClick={toggleAddDiseaseModal}
                                            ...
                                            <tr key={disease.id}>
                                                <td className="h-px w-px whitespace-nowrap">
                                                    <div className="pl-6 py-3">
                                                        <label htmlFor={"checkbox-" + disease.id}
                                                               className="flex"
                                                        >
                                                            <input id={"checkbox-" + disease.id}
                                                                   type="checkbox"
                                                                   className="shrink-0 border-gray-200 rounded text-blue-600 pointer-events-none focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800"/>
                                                            <span className="sr-only">Checkbox</span>
                                                        </label>
                                                    ...
                                                    <div className="px-6 py-3">
                                                        <div className="flex items-center gap-x-2">
                                                            <div className="grow">
                                                                <span
                                                                    className="text-sm text-gray-600 dark:text-gray-400">
                                                                    {disease.medicineIds?.map(medicineId => {
                                                                        return <span
                                                    ...
                                                    <div className="px-6 py-1.5">
                                                        <div
                                                            ...
                                                            >
                                                                ...
                                                                <div className="py-2 first:pt-0 last:pb-0">
                                                                    <a onClick={() => (disease.id && deleteDisease(disease.id))}
